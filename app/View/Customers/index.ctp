            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <div class="input-group"> 
                        <ul class="filters">  
                            <li><?php $url = array('controller' => 'Customer', 'action' => 'index'); ?></li>
                ...
                <table class="table table-hover">
                    ...
                    <?php foreach ($customers as $customer): ?>
                        <tr>
                            ...
                            <td>
                                <span class="label label-info"><?php echo $this->Html->link(__('View'), array('action' => 'view', $customer['Customer']['id'])); ?></span>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
