...
<?php echo $this->Form->create('UacSection'); ?>
	<fieldset>
		<legend><?php echo __('Edit Uac Section'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UacSection.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('UacSection.id'))); ?></li>
