<div class="row">
    <ol class="breadcrumb action-link">
        ...
        <li><a href="javascript:void(0)" onclick="printData('list-transfers')" class="print" rel="list-saps"><i class="fa fa-print"></i>&nbsp;Print List</a></li>
    </ol>
</div><!--/.row-->
...
<div class="row">
            <div class="col-xs-12">
              <div class="box" id="list-transfers">
