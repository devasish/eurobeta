            ...
            <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover" id="loads-table">
                    ...
                    <?php $x = 1; ?>
                        <tr>
                            <td><?php echo $x++; ?></td>
                            <td><?php echo $this->Form->input('PalletLoad.0.quantity', array('label' => FALSE, 'div' => FALSE, 'class' => 'loads-input', 'data-index' => '0', 'class'=>'form-control')); ?></td>
                            <td><?php echo $this->Form->input('PalletLoad.0.wt_with_pallet', array('label' => FALSE, 'div' => FALSE, 'class' => 'loads-input', 'data-index' => '0', 'class'=>'form-control')); ?></td>
