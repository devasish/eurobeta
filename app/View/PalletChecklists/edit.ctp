...
<?php echo $this->Form->create('PalletChecklist'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pallet Checklist'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PalletChecklist.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PalletChecklist.id'))); ?></li>
