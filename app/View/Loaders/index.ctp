<div class="row">
    <ol class="breadcrumb action-link">
        ...
        <li><?php echo $this->Html->link('<i class="fa fa-plus"></i>' . '&nbsp;&nbsp;' . __('Create Loader'), array('action' => 'add'), array('escape' => FALSE)); ?></li>
    </ol>
</div><!--/.row-->
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Loaders List</h3>
                <div class="box-tools">
                    <div class="input-group"> 
                        <ul class="filters">  
                            <li><?php $url = array('controller' => 'Loader', 'action' => 'index'); ?></li>
			...
			<th><?php echo $this->Paginator->sort('loader_name'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
                    </tr>

                    <?php foreach ($loaders as $loader): ?>
                        <tr>
                            <td><?php echo h($loader['Loader']['id']); ?>&nbsp;</td>
                            <td><?php echo h($loader['Loader']['loader_name']); ?>&nbsp;</td>                            
                            <td>
                                <span class="label label-info"><?php echo $this->Html->link(__('View'), array('action' => 'view', $loader['Loader']['id'])); ?></span>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
